...
public class ArticleControllerTest {
    ...
    public void testAddArticle() {
        Article newArticle = new Article(/* Initialize with necessary fields */);
    ...
    public void testDeleteArticle() {
        long articleIdToDelete = 2L; // ID de l'article à supprimer
    ...
    public void testFindArticleById() {
        ...
        long articleIdToFind = 1L; // ID de l'article à rechercher
    ...
    public void testUpdateArticle() throws Exception {
        ...
        ArticleResponse articleIdToUpdate =  articleService.FindById(1L);
        ...
        ResponseEntity<ArticleResponse> response = restTemplate.exchange(
                "http://localhost:" + port + "/articles/" + articleIdToUpdate,
    ...
    public void testGetArticleAuteur() {
        long auteurId = 1L; // ID de l'auteur
        ...
        // Ajoutez d'autres assertions si nécessaire après avoir récupéré l'auteur de l'article
    }
}
